...
//
//public class FiltraLive extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_filtra_live);
//    }
//}
                                ...
                                .addOnSuccessListener(
                                        new OnSuccessListener<List<Face>>() {
                                            ...
                                            public void onSuccess(List<Face> faces) {
                                                ...
                                                ArrayList<Boolean> Trump = new ArrayList<Boolean>();
                                                if (faces.size() > 0) {
                                                    ...
                                                    for (Face face : faces) {
                                                        ...
                                                        testo.setText("Sono stati trovati "+ faces.size() + " volti da analizzare");
                                                        ...
                                                        try {
                                                            ...
                                                            if (labelProbArray != null)
                                                                System.out.println(" " + labelProbArray);
                                                    ...
                                                    rettangolo.setTargets(sources,Trump);
                                                    // sources.clear();
                                                    ...
                                                    testo.setText("Non sono stati trovati volti da analizzare ");
